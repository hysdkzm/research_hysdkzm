...
var constraints = {
    audio:false,
    video: {width: 1960, height: 980, frameRate: { ideal: 10, max:20} }
};
			    ...
			    //var ctx = canvas.getContext("2d");
		 	    //var ctx1 = canvas1.getContext("2d");
				    ...
				    console.log(tbl[i][0]);
                		    ...
                		    tbl[i][2] = (tbl[i][2] - (tbl[i][4] / 2)) * (1600 / 416) ;  //x(320)
                		    tbl[i][3] = (tbl[i][3] - (tbl[i][5] / 2 )) * (800 / 416);   //y(240)
                		    tbl[i][4] = tbl[i][4] * (1600 / 416);  //width(320)
                                    tbl[i][5] = tbl[i][5] * (800 / 416);   //height(240)
                                    ctx2.beginPath () ;
